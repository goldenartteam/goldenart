...
contract GoldenArt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldenArt";
    ...
    address payable public teamWalletAddress = payable(0x9A4a544ccef97AeCF7AC554EFbfe29BE4d328704);
